use game::contants::ENTITY_COLUNMS_N;
use game::contants::ENTITY_SIZE;
use game::contants::TEXTURE_FILES;
use game::contants::WINDOW_HEIGHT;
use game::contants::WINDOW_WIDTH;
use game::frame_hate;
use game::load_image;
